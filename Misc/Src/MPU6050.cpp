...
MPU6050::MPU6050(I2C_HandleTypeDef *hi2c,GPIO_TypeDef* gpioIntPort, uint16_t gpioIntPin,int frequency,SerialBuffer *serialDebugRef) :
		m_hi2c(hi2c), m_serialDebug(serialDebugRef), m_gpioIntPort(gpioIntPort), m_gpioIntPin(gpioIntPin) { // : I2C(sda,scl) //constructor
